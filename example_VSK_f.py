...
save_pics = True
saving_folder = 'data/results_example_VSK_f'
...
EPOCHS = 1000
# SPLITTING X IN TRAINING AND VALIDATION DATA FOR TRAInING THE deltaNN
...
history = model_psi.fit(
    ...
    callbacks=[
        tf.keras.callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=75),
        tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=550,
...
# VSKFitter (WITH PRETRAINED model_psi
